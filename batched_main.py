...
from utils import print_args, construct_global_graph, accuracy, greedy_search
from dataset import FoursquareDataset, BatchedDataset
from models import GlobalTUL
...
if __name__ == "__main__":
    ...
    TrajTrajGraph = construct_global_graph(dataset)            # N_trajs, N_vocabs
    ...
    with open(savepath, "w") as fsave:
        ...
        # with open(Path(args.datadir) / "test_trajs_pred_by_batched_main.txt", "w") as f:
